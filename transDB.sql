...
--
-- Table structure for table `courses_userprofile`
--

DROP TABLE IF EXISTS `courses_userprofile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `courses_userprofile` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `user_id` (`user_id`),
  CONSTRAINT `courses_userprofile_user_id_5844ebaa_fk_users_customuser_id` FOREIGN KEY (`user_id`) REFERENCES `users_customuser` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `courses_userprofile`
--

LOCK TABLES `courses_userprofile` WRITE;
/*!40000 ALTER TABLE `courses_userprofile` DISABLE KEYS */;
INSERT INTO `courses_userprofile` VALUES
(1,NULL,4,'2024-12-30 18:56:20.499018','',NULL,NULL),
(2,NULL,3,'2024-12-30 18:48:50.368051','',NULL,NULL);
/*!40000 ALTER TABLE `courses_userprofile` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `courses_userprofile_completed_courses`
--

DROP TABLE IF EXISTS `courses_userprofile_completed_courses`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `courses_userprofile_completed_courses` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `userprofile_id` bigint(20) NOT NULL,
  `course_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `courses_userprofile_comp_userprofile_id_course_id_72beab52_uniq` (`userprofile_id`,`course_id`),
  KEY `courses_userprofile__course_id_86fd236b_fk_courses_c` (`course_id`),
  CONSTRAINT `courses_userprofile__course_id_86fd236b_fk_courses_c` FOREIGN KEY (`course_id`) REFERENCES `courses_course` (`id`),
  CONSTRAINT `courses_userprofile__userprofile_id_429b65d8_fk_courses_u` FOREIGN KEY (`userprofile_id`) REFERENCES `courses_userprofile` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `courses_userprofile_completed_courses`
--

LOCK TABLES `courses_userprofile_completed_courses` WRITE;
/*!40000 ALTER TABLE `courses_userprofile_completed_courses` DISABLE KEYS */;
/*!40000 ALTER TABLE `courses_userprofile_completed_courses` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `courses_userprofile_interests`
--

DROP TABLE IF EXISTS `courses_userprofile_interests`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `courses_userprofile_interests` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `userprofile_id` bigint(20) NOT NULL,
  `tag_id` bigint(20) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `courses_userprofile_inte_userprofile_id_tag_id_6b259c74_uniq` (`userprofile_id`,`tag_id`),
  KEY `courses_userprofile_interests_tag_id_0f973034_fk_courses_tag_id` (`tag_id`),
  CONSTRAINT `courses_userprofile__userprofile_id_3a43a2fb_fk_courses_u` FOREIGN KEY (`userprofile_id`) REFERENCES `courses_userprofile` (`id`),
  CONSTRAINT `courses_userprofile_interests_tag_id_0f973034_fk_courses_tag_id` FOREIGN KEY (`tag_id`) REFERENCES `courses_tag` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `courses_userprofile_interests`
--

LOCK TABLES `courses_userprofile_interests` WRITE;
/*!40000 ALTER TABLE `courses_userprofile_interests` DISABLE KEYS */;
/*!40000 ALTER TABLE `courses_userprofile_interests` ENABLE KEYS */;
UNLOCK TABLES;
...
(2,'pbkdf2_sha256$870000$hoE39F8yofY79WtFCRKRsg$/Ld13ce5TO8RJAKw6U4fVLcPR7QJeDzeA7vEr9XQ3jc=','2024-12-23 19:11:32.513886',0,'Gabby','','','gabrielakinshola021@gmail.com',0,1,'2024-12-20 14:19:02.851328',0,1),
...
(4,'pbkdf2_sha256$870000$WE8ryXtUCxcCvl3eqBKo39$J9DBbv7j5gnHnLN6v7FFV16jyPrQtreBBHmMv8Mf3iM=','2025-01-11 14:19:43.681990',1,'admin','','','gabrielakinshola3@gmail.com',1,1,'2024-12-24 10:06:24.000000',1,0);
...
-- Dump completed on 2025-01-28 18:02:54
