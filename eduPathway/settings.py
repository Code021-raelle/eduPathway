"""
Django settings for eduPathway project.
...
SECRET_KEY = 'django-insecure-67-a8df#ux$k_68yuy@!t+@750&b7s&bx#)@u9d^%lqc4ba!s3'
...
WSGI_APPLICATION = 'eduPathway.wsgi.application'
